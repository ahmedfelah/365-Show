...
public protocol ChiefsPlayerDelegate:AnyObject {
    ...
    func chiefsplayerBackwardAction(_ willTriggerAction:Bool, timeline: Timeline?) -> CControlsManager.Action?
    
    /// Forward action, Return nil to hide forward button
    /// - Parameter willTriggerAction: a boolean value indicating thet action will be triggered now
    func chiefsplayerForwardAction(_ willTriggerAction:Bool, timeline: Timeline?) -> CControlsManager.Action?
...
public extension ChiefsPlayerDelegate {
    ...
    func chiefsplayerDebugLog(_ string:String) {}
    func chiefsplayerBackwardAction(_ willTriggerAction:Bool, timeline: Timeline) -> CControlsManager.Action? {return nil}
    func chiefsplayerForwardAction(_ willTriggerAction:Bool, timeline: Timeline) -> CControlsManager.Action?  {return nil}
    func chiefsplayerProgressChanged(timeline: Timeline) -> CControlsManager.Action?  {return nil}
