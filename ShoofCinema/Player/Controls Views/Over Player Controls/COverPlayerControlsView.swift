...
class COverPlayerControlsView: CBaseControlsView {
    ...
    //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    @IBAction func episodesBtn(_ sender: Any) {
        CControlsManager.shared.episodesBtnAction()
    }
...
//        skipButton.isHidden = true
    ...
    func controlsEpisodesHideButtonToggle(to isHidden: Bool) {
        episodes.isHidden = isHidden
    }
